            ...
            <div className='space-y-[40px]'>
                {privacyPolicy.map(section => (
                    <div className='space-y-[20px]' key={section.id}>
                        ...
                        {section.text && <p className='text-md font-medium'>{section.text}</p>}
                        ...
                        {section.link && (
                            <p>
                                {section.text}{' '}
                                <a href={section.link}>contact us</a>
                            </p>
                        )}
                    </div>
                ))}
