    ...
    return (
        <div>
            <div className=" relative h-[700px] md:h-[500px] w-full flex  justify-center bg-cover bg-none bg-center bg-no-repeat  transition duration-500 transform" style={{ backgroundImage: `url(${image})` }}>
                <div className="bg-gradient-to-b from-[rgba(0,0,0,0.0)] to-[rgba(0,0,0,0.5)] absolute inset-x-0 bottom-0  p-12 space-y-8">
                    ...
                    <button className='bg-[yellow] px-6 w-[200px] py-3 rounded-sm hover:scale-105 focus:105 transition duration-500 transform text-gray-900 font-semibold'>
