...
export default function Header({ params }: any) {
    ...
    return (
        <nav className='py-5 mt-3 flex flex-row items-center bg-transparent dark:bg-transparent rounded-lg justify-between'>
            ...
            <div
                id='mobileNav'
                className={`fixed h-screen w-[350px] p-4 space-y-[20px]  top-0 end-0 bg-white dark:bg-neutral-900 z-10 sm:hidden ${mobileNavVisible ? '' : 'hidden' // Toggle visibility based on state
                    }`}
            >
                <div>
                    <button
