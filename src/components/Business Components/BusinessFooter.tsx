    ...
    return (
        <footer >
            <div className='space-y-8 '>
                <div className='w-fit'>
                    <Link href={`/${business.business_url}/properties`} className='text-gray-600 dark:text-slate-300 underline w-fit'>
                ...
                <div className='flex justify-center items-center text-gray-600 dark:text-slate-400 text-sm text-center'>&copy; {currentYear} {business.business_name}</div>
            </div>
        </footer>
    );
}
