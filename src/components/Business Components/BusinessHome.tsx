    ...
    <div>
      <div className="flex flex-col sm:justify-center sm:items-center space-y-[30px] w-full ">
        <div className="space-y-[30px] w-full flex flex-col items-center justify-center">
          <h1 className="text-gray-600 dark:text-slate-200 text-3xl font-bold sm:text-center">
            {business.data.business_name}
          </h1>
          <h2 className="text-gray-600 dark:text-slate-200 text-md font-regular md:max-w-2xl text-center">
        ...
        <div className=" w-full max-w-xl flex flex-col items-center justify-center ">
          <ContactBusiness
            offers={offers}
            business={business.data.business_url}
          />
        </div>
      </div>
