    ...
    return (
        <div className="flex flex-col sm:justify-between sm:items-center space-y-[30px] w-full  md:space-x-[50px]">
            <div className='space-y-[30px]'>
                <h1 className='text-gray-600 dark:text-slate-200 text-3xl font-bold text-center'>{business.data.business_name}</h1>
                <h2 className='text-gray-600 dark:text-slate-200 text-md font-thin md:max-w-2xl text-center'>{business.data.business_description}</h2>
            </div>
            <div className=" w-full max-w-2xl">
                <ContactBusiness offers={offers} />
            </div>
