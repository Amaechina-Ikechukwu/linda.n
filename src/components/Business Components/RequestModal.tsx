                ...
                <div >
                    <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '100vw', height: '100vh', backgroundColor: 'rgba(0,0,0,0.4)', zIndex: 20 }} className="flex items-center justify-center  ">
                        <div className='w-full flex items-center justify-center'>
                            <div className=' w-11/12 md:w-3/6 bg-zinc-50 dark:bg-neutral-900 p-4 px-6'>
                                <div className=' w-full flex justify-end'>
                                    <button
                                        ...
                                        className="mt-4 p-2 bg-slate-100 dark:bg-neutral-950 text-gray-600 dark:text-slate-100 rounded-full hover:bg-red-100 focus:outline-none focus:ring focus:bg-red-100 "
                                    >
